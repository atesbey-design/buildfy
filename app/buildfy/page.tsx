              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <div className="relative group">
                    <div
                      className={`absolute -inset-1 bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400 rounded-full blur-md opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200 animate-gradient-xy ${status === "initial" || status === "uploading" || status === "creating" ? "hidden" : ""}`}
                    ></div>
                    <button
                      onClick={createApp}
                      disabled={
              ...
              <div className="flex flex-col justify-center items-center text-center h-full py-8">
                <div className="max-w-xl px-4">
                  ...
                  <p className="text-base sm:text-lg text-gray-600">
                    Simply upload your design mockup and watch as we transform
                    it into a fully functional React application with Tailwind
                    styling.
                  </p>
                </div>
              </div>
